...
const StasMonth = () => {
  ...
  useEffect(() => {
    if (orders.length > 0) {
      ...
      orders.forEach((order) => {
        ...
        const key = `${date.getFullYear()}-${(date.getMonth() + 1).toString().padStart(2, '0')}`; // Tahun-Bulan (misal 2025-01)
  ...
  return (
    <div className="w-full h-[500px]">
      <h2 className="text-2xl font-bold mb-4">Orders Chart (by Month)</h2>
