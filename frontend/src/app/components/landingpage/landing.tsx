...
import AnimasiScroll from "@/app/anim/scroll";
import AnimasiScroll2 from "@/app/anim/scroll2";
import AnimasiScroll3 from "@/app/anim/scroll3";
import AnimasiTransition2 from "@/app/anim/transition2";
    ...
    <div className="relative">
      ...
      <div role="flex" className="flex justify-center mt-[100px] gap-[50px]">
          ...
          >
            <div className="flex flex-col pt-[20px] gap-5 justify-center items-center relative z-10 p-5">
              ...
              <p className="text-white text-[20px]">
                Be an organizer to be the one who make the race. Make a
                gratefull, exclusive, or fantastic evolution of events
              </p>
              <GesturesButton>
                <button
        ...
        <AnimasiScroll2>
          <div
            role="Card"
            className="w-[280px] h-[250px] bg-blue-950/70 rounded-md relative z-10"
          >
